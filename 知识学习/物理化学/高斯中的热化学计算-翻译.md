...
在整个分析过程中，需要意识到的一个最重要的近似是：所有方程均假设粒子间无相互作用，因此仅适用于理想气体。由于所研究的实际体系都是非理想的，这一限制会引入一定的误差。此外，对于电子贡献，假设第一激发态及所有更高激发态均完全不可达。这一近似通常不会带来问题，但对于具有低激发电子态的体系，可能会引入一些误差。
